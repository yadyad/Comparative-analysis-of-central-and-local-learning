...
class argument:
    """
    intermediate class for saving configuration related to federated learning
    """
    def __init__(self):
        ...
        self.n_parties = self.cfg.no_of_local_machines  #number of clients
        ...
        self.seed = self.cfg.federated_learning.seed    # random seed while selecting clients
